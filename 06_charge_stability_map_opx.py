...
# Voltages in Volt
voltages_Px = np.linspace(-0.2, 0.2, n_voltages_Px)
...
if simulate:
    ...
    while results.is_processing():
        ...
        for ind, rr in enumerate(tank_circuits):
