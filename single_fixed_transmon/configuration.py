...
# octave_1 = OctaveUnit("octave1", "192.168.88.232", port=80, con="con1")
octave_1 = OctaveUnit("octave1", "172.16.33.101", port=11232, con="con1")
...
#                Resonators                 #
#############################################
resonator_LO = 2.3 * u.GHz
resonator_IF = 190.576 * u.MHz
