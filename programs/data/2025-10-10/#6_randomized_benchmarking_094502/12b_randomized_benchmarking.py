...
if simulate:
    ...
    if state_discrimination:
        result_names = mp_result_names(qub_key_subset, single_tags = ["iteration"], mp_tags = ["state"])
        iteration, state = mp_fetch_all(res_handles, qub_key_subset, num_single_tags=1)
