...
storage_band = choose_band(storage_LO)
storage_port = 2
...
qubit_band = choose_band(qubit_LO)
qubit_port = 4
...
pdh_demod_len = readout_len
pdh_carrier_len = readout_len
pdh_mod_high_len = readout_len
pdh_mod_low_len = readout_len
...
config = {
    ...
    "elements": {
        "qubit": {
            "MWInput": {"port": ("con1", mw_fem_slot, qubit_port)},
        ...
        "storage": {
            "MWInput": {"port": ("con1", mw_fem_slot, storage_port)},
        ...
        "resonator": {
            "MWInput": {"port": ("con1", mw_fem_slot, resonator_port)},
            "MWOutput": {"port": ("con1", mw_fem_slot, resonator_readout_port)},
    ...
    "waveforms": {
        ...
        "storage_off_pump_pulse_wf": {
            "type": "constant",
            "sample": storage_off_pump_amp,
        },
        "resonator_off_pump_pulse_wf": {
            "type": "constant",
            "sample": resonator_off_pump_amp,
        },
