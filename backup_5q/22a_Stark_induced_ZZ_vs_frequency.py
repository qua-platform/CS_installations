...
from quam_libs.lib.fit import (fit_oscillation_decay_exp,
                               oscillation_decay_exp, peaks_dips)
from quam_libs.lib.plot_utils import QubitGrid, grid_iter
from quam_libs.lib.save_utils import fetch_results_as_xarray
from quam_libs.macros import (active_reset, multiplexed_readout, node_save,
                              qua_declaration, readout_state)
...
if node.parameters.simulate:
    ...
    ds = fetch_results_as_xarray(job.result_handles, qubit_pairs, {"qc_state": [0, 1], "time": idle_time_ns, "freq": dfs})
