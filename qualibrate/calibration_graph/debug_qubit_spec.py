...
# Single QUA script generated at 2025-04-17 16:44:07.106198
...
with program() as prog:
    ...
    with for_(v1,0,(v1<500),(v1+1)):
        r1 = declare_stream()
        save(v1, r1)
        with for_(v6,-50000000,(v6<=49750000),(v6+250000)):
            update_frequency("q1.I", ((v6+100000000.0)+0.0), "Hz", False)
            update_frequency("q1.Q", ((v6+100000000.0)+0.0), "Hz", False)
            align("q1.I", "q1.Q", "q1.resonator", "q1.z")
            play("const"*amp(0.0), "q1.z", duration=5004)
            wait(4, "q1.I", "q1.Q")
            frame_rotation_2pi(0.25, "q1.Q")
            align("q1.I", "q1.Q")
            play("x180_Cosine"*amp(0.1), "q1.I", duration=5004)
            play("x180_Cosine"*amp(0.1), "q1.Q", duration=5004)
            reset_frame("q1.Q")
            align("q1.I", "q1.Q", "q1.resonator", "q1.z")
    ...
    with for_(v1,0,(v1<500),(v1+1)):
        save(v1, r1)
        with for_(v6,-50000000,(v6<=49750000),(v6+250000)):
            update_frequency("q2.I", ((v6+200000000.0)+0.0), "Hz", False)
            update_frequency("q2.Q", ((v6+200000000.0)+0.0), "Hz", False)
            align("q2.I", "q2.Q", "q2.resonator", "q2.z")
            play("const"*amp(0.0), "q2.z", duration=5004)
            wait(4, "q2.I", "q2.Q")
            frame_rotation_2pi(0.25, "q2.Q")
            align("q2.I", "q2.Q")
            play("x180_Cosine"*amp(0.1), "q2.I", duration=5004)
            play("x180_Cosine"*amp(0.1), "q2.Q", duration=5004)
            reset_frame("q2.Q")
            align("q2.I", "q2.Q", "q2.resonator", "q2.z")
    ...
    with stream_processing():
        r1.save("n")
        r2.buffer(400).average().save("I1")
        r4.buffer(400).average().save("Q1")
        r3.buffer(400).average().save("I2")
        r5.buffer(400).average().save("Q2")
