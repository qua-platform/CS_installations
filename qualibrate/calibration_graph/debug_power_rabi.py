...
# Single QUA script generated at 2025-04-23 14:09:13.845832
...
with program() as prog:
    ...
    with stream_processing():
        r1.save("n")
        r6.map(FUNCTIONS.boolean_to_int()).buffer(30).buffer(1).save_all("state1")
        r7.map(FUNCTIONS.boolean_to_int()).buffer(30).buffer(1).save_all("state2")
...
config = {
    ...
    "waveforms": {
        ...
        "q2.I.x180_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, 0.0006078567838525803, 0.002415683964001012, 0.005376659766087362, 0.009414096472166608, 0.014423426592319197, 0.020274911107713185, 0.02681699964304324, 0.03388025554164526, 0.041281744185903045, 0.04882977090775335, 0.056328845779896226, 0.06358474670222596, 0.07040954965220353, 0.07662649581832848, 0.08207456956050976, 0.0866126686305663, 0.09012325864633737, 0.09251541717044257] + [0.09372718855365059] * 2 + [0.09251541717044257, 0.09012325864633738, 0.08661266863056633, 0.08207456956050978, 0.07662649581832848, 0.07040954965220349, 0.06358474670222598, 0.05632884577989625, 0.04882977090775335, 0.04128174418590308, 0.033880255541645296, 0.026816999643043262, 0.0202749111077132, 0.014423426592319202, 0.009414096472166608, 0.0053766597660873565, 0.0024156839640010067, 0.0006078567838525803, 0.0],
        },
        "q2.I.x90_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, 0.00030392839192629016, 0.001207841982000506, 0.002688329883043681, 0.004707048236083304, 0.007211713296159598, 0.010137455553856593, 0.01340849982152162, 0.01694012777082263, 0.020640872092951523, 0.024414885453876677, 0.028164422889948113, 0.03179237335111298, 0.035204774826101765, 0.03831324790916424, 0.04103728478025488, 0.04330633431528315, 0.045061629323168685, 0.04625770858522128] + [0.04686359427682529] * 2 + [0.04625770858522128, 0.04506162932316869, 0.04330633431528316, 0.04103728478025489, 0.03831324790916424, 0.035204774826101744, 0.03179237335111299, 0.028164422889948124, 0.024414885453876677, 0.02064087209295154, 0.016940127770822648, 0.013408499821521631, 0.0101374555538566, 0.007211713296159601, 0.004707048236083304, 0.0026883298830436783, 0.0012078419820005033, 0.00030392839192629016, 0.0],
        },
        "q2.I.-x90_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, -0.0006474868681043578, -0.002573177902642726, -0.005727198717339505, -0.010027861829824942, -0.015363782324520032, -0.021596762663442206, -0.02856537192984729, -0.03608912680417736, -0.04397316598723385, -0.05201329700547076, -0.060001284688802205, -0.06773024435212678, -0.07500000000000001, -0.08162226877976886, -0.08742553740855505, -0.09225950427718974, -0.09599897218294122, -0.0985470908713026, -0.0998378654067105, -0.09983786540671051, -0.0985470908713026, -0.09599897218294123, -0.09225950427718976, -0.08742553740855508, -0.08162226877976886, -0.07499999999999998, -0.06773024435212681, -0.060001284688802226, -0.05201329700547076, -0.043973165987233886, -0.0360891268041774, -0.028565371929847313, -0.021596762663442223, -0.015363782324520037, -0.010027861829824942, -0.0057271987173395, -0.0025731779026427204, -0.0006474868681043578, 0.0],
