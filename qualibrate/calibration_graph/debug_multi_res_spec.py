...
# Single QUA script generated at 2025-04-18 15:26:51.213587
...
with program() as prog:
    ...
    with stream_processing():
        r1.save("n")
        r2.buffer(300).average().save("I1")
        r4.buffer(300).average().save("Q1")
        r3.buffer(300).average().save("I2")
        r5.buffer(300).average().save("Q2")
