...
with program() as prog:
    ...
    qubits[1].I.update_frequency(-100e6)
    qubits[1].Q.update_frequency(-100e6)
    qubits[0].I.update_frequency(-100e6)
    qubits[0].Q.update_frequency(-100e6)
