...
# Single QUA script generated at 2025-04-23 18:26:39.174511
...
with program() as prog:
    ...
    v12 = declare(int, )
    v13 = declare(int, )
    a3 = declare(int, size=4)
    a4 = declare(int, size=4)
    v14 = declare(int, )
    ...
    with stream_processing():
        r3.save("iteration")
        r1.buffer(1).map(FUNCTIONS.average()).buffer(4).buffer(1).save("state1")
        r2.buffer(1).map(FUNCTIONS.average()).buffer(4).buffer(1).save("state2")
