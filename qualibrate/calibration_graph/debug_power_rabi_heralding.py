...
# Single QUA script generated at 2025-04-25 16:46:41.399339
...
with program() as prog:
    ...
    with for_(v1,0,(v1<10),(v1+1)):
        r1 = declare_stream()
        save(v1, r1)
        with for_(v13,1,(v13<=1),(v13+1)):
            with for_(v12,0.0,(v12<1.475),(v12+0.05)):
                ...
                with for_(v14,0,(v14<v13),(v14+1)):
                    frame_rotation_2pi(0.25, "q1.Q")
                    align("q1.I", "q1.Q")
                    play("x180_Cosine"*amp(v12), "q1.I")
                    play("x180_Cosine"*amp(v12), "q1.Q")
                    reset_frame("q1.Q")
                align("q1.I", "q1.Q", "q1.resonator", "q1.z")
                measure("readout", "q1.resonator", dual_demod.full("iw1", "iw2", v2), dual_demod.full("iw3", "iw1", v4))
                assign(v6, (v2>0.0))
        ...
        with for_(v13,1,(v13<=1),(v13+1)):
            with for_(v12,0.0,(v12<1.475),(v12+0.05)):
                ...
                with for_(v14,0,(v14<v13),(v14+1)):
                    ...
                    align("q2.I", "q2.Q")
                    play("x180_Cosine"*amp(v12), "q2.I")
                    play("x180_Cosine"*amp(v12), "q2.Q")
                    reset_frame("q2.Q")
                align("q2.I", "q2.Q", "q2.resonator", "q2.z")
                measure("readout", "q2.resonator", dual_demod.full("iw1", "iw2", v3), dual_demod.full("iw3", "iw1", v5))
                assign(v7, (v3>0.0))
...
config = {
    ...
    "elements": {
        ...
        "q1.I": {
            ...
            "intermediate_frequency": 115250000.0,
            "singleInput": {
                "port": ('con1', 5, 1),
            },
        },
        ...
        "q2.I": {
            ...
            "intermediate_frequency": 177250000.0,
            "singleInput": {
                "port": ('con1', 5, 3),
            },
        },
    ...
    "waveforms": {
        ...
        "q1.I.x90_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, 3.576018200472159e-05, 0.00014211455808892313, 0.00031630860577740627, 0.0005538307907349618, 0.000848529413135851, 0.0011927719334579524, 0.001577642651247199, 0.001993173617076132, 0.002428602797198154, 0.0028726528045685267, 0.00331382297724509, 0.0037406872394915515, 0.0041421900311372035, 0.004507932640778132, 0.00482844252694039, 0.005095418651928472, 0.005301946474341289, 0.005442677032062422] + [0.005513965477569253] * 2 + [0.005442677032062422, 0.00530194647434129, 0.005095418651928473, 0.004828442526940392, 0.004507932640778132, 0.004142190031137202, 0.003740687239491553, 0.0033138229772450914, 0.0028726528045685267, 0.002428602797198156, 0.0019931736170761337, 0.0015776426512472, 0.0011927719334579535, 0.0008485294131358514, 0.0005538307907349618, 0.00031630860577740595, 0.00014211455808892283, 3.576018200472159e-05, 0.0],
        },
        "q1.I.-x90_Cosine.wf": {
            "type": "arbitrary",
        ...
        "q2.I.x90_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, 0.00036915317705011897, 0.001467051834822117, 0.0032652609747793205, 0.005717207924752633, 0.008759388546686203, 0.012313011960455885, 0.01628604118627753, 0.020575576854138546, 0.025070522243430742, 0.029654460629657587, 0.03420867041644782, 0.03861519996253991, 0.0427599224673335, 0.046535491795076954, 0.04984412268339704, 0.05260012333023008, 0.05473211476648361, 0.056184879533842234, 0.056920791787933564, 0.05692079178793357, 0.056184879533842234, 0.05473211476648362, 0.05260012333023009, 0.049844122683397045, 0.046535491795076954, 0.04275992246733348, 0.038615199962539926, 0.03420867041644783, 0.029654460629657587, 0.025070522243430763, 0.020575576854138567, 0.01628604118627754, 0.012313011960455896, 0.008759388546686207, 0.005717207924752633, 0.0032652609747793175, 0.0014670518348221138, 0.00036915317705011897, 0.0],
        },
        "q2.I.-x90_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, -0.0006474868681043578, -0.002573177902642726, -0.005727198717339505, -0.010027861829824942, -0.015363782324520032, -0.021596762663442206, -0.02856537192984729, -0.03608912680417736, -0.04397316598723385, -0.05201329700547076, -0.060001284688802205, -0.06773024435212678, -0.07500000000000001, -0.08162226877976886, -0.08742553740855505, -0.09225950427718974, -0.09599897218294122, -0.0985470908713026, -0.0998378654067105, -0.09983786540671051, -0.0985470908713026, -0.09599897218294123, -0.09225950427718976, -0.08742553740855508, -0.08162226877976886, -0.07499999999999998, -0.06773024435212681, -0.060001284688802226, -0.05201329700547076, -0.043973165987233886, -0.0360891268041774, -0.028565371929847313, -0.021596762663442223, -0.015363782324520037, -0.010027861829824942, -0.0057271987173395, -0.0025731779026427204, -0.0006474868681043578, 0.0],
    ...
    "integration_weights": {
        "q1.resonator.readout.iw1": {
            "cosine": [(0.9999393885034552, 2500)],
            "sine": [(-0.011009964547452504, 2500)],
        },
        "q1.resonator.readout.iw2": {
            "cosine": [(0.011009964547452504, 2500)],
            "sine": [(0.9999393885034552, 2500)],
        },
        ...
        "q2.resonator.readout.iw1": {
            "cosine": [(0.995408333676364, 2500)],
            "sine": [(0.09571963877723466, 2500)],
        },
        "q2.resonator.readout.iw2": {
            "cosine": [(-0.09571963877723466, 2500)],
            "sine": [(0.995408333676364, 2500)],
        },
