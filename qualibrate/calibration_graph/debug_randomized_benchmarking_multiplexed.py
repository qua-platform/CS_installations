...
# Single QUA script generated at 2025-04-21 13:48:18.089711
...
with program() as prog:
    ...
    with for_(v4,0,(v4<2000),(v4+1)):
        assign(v12, 0)
        with for_(v14,0,(v14<1000),(v14+1)):
    ...
    with stream_processing():
        r2.save("iteration")
        r0.buffer(1).map(FUNCTIONS.average()).buffer(51).buffer(2000).save("state1")
        r1.buffer(1).map(FUNCTIONS.average()).buffer(51).buffer(2000).save("state2")
