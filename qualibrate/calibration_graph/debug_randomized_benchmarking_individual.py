...
# Single QUA script generated at 2025-04-21 13:49:21.298691
# QUA library version: 1.2.2

# Single QUA script generated at 2025-04-21 12:59:12.657225
# QUA library version: 1.2.2
...
with program() as prog:
    ...
    v12 = declare(int, )
    v13 = declare(int, )
    a3 = declare(int, size=1001)
    a4 = declare(int, size=1001)
    v14 = declare(int, )
    ...
    v19 = declare(int, )
    v20 = declare(int, )
    a7 = declare(int, size=1001)
    a8 = declare(int, size=1001)
    v21 = declare(int, )
    ...
    v25 = declare(fixed, )
    align()
    set_dc_offset("q1.z", "single", 0.1)
    set_dc_offset("q2.z", "single", 0.2)
    set_dc_offset("c12.z", "single", 0.0)
    align("q1.I", "q1.Q", "q1.resonator", "q1.z")
    with for_(v4,0,(v4<1),(v4+1)):
        assign(v12, 0)
        with for_(v14,0,(v14<10),(v14+1)):
            assign(v13, Random(v15).rand_int(24))
            assign(v12, a1[((v12*24)+v13)])
            assign(a3[v14], v13)
            assign(a4[v14], a2[v12])
        assign(v2, 0)
        with for_(v1,1,(v1<=10),(v1+1)):
            assign(v3, a3[v1])
            ...
            with if_(((v1==1)|(v1==v2))):
                with for_(v5,0,(v5<1),(v5+1)):
                    ...
                    assign(v10, Cast.to_int((v17>1.477626256073842e-06)))
    ...
    #                 assign(v11, Cast.to_int((v24>1.3385982412288837e-07)))
    ...
    #     r6.save("iteration")
    #     r7.buffer(1).map(FUNCTIONS.average()).buffer(51).buffer(2000).save("state1")
    #     r8.buffer(1).map(FUNCTIONS.average()).buffer(51).buffer(2000).save("state2")
...
config = {
    ...
    "waveforms": {
        ...
        "q2.I.x180_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, 0.0007133052235661991, 0.0028347466636564206, 0.006309380101314227, 0.011047214355645235, 0.016925542008132073, 0.023792117460318733, 0.03146910001483969, 0.039757659856066184, 0.048443127637890576, 0.05730055430702986, 0.06610053716534543, 0.07461516127922523, 0.08262390235664593, 0.08991933821050041, 0.09631252088428996, 0.10163787030494775, 0.10575746271975604, 0.10856460284909358] + [0.10998658723813341] * 2 + [0.10856460284909358, 0.10575746271975604, 0.10163787030494778, 0.09631252088428999, 0.08991933821050041, 0.08262390235664589, 0.07461516127922525, 0.06610053716534546, 0.05730055430702986, 0.04844312763789062, 0.03975765985606622, 0.03146910001483971, 0.023792117460318753, 0.01692554200813208, 0.011047214355645235, 0.006309380101314221, 0.0028347466636564145, 0.0007133052235661991, 0.0],
        },
        "q2.I.x90_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, 0.00035665261178309955, 0.0014173733318282103, 0.0031546900506571134, 0.0055236071778226176, 0.008462771004066037, 0.011896058730159366, 0.015734550007419846, 0.019878829928033092, 0.024221563818945288, 0.02865027715351493, 0.033050268582672716, 0.03730758063961261, 0.04131195117832297, 0.044959669105250205, 0.04815626044214498, 0.050818935152473876, 0.05287873135987802, 0.05428230142454679] + [0.054993293619066706] * 2 + [0.05428230142454679, 0.05287873135987802, 0.05081893515247389, 0.048156260442144994, 0.044959669105250205, 0.041311951178322946, 0.03730758063961263, 0.03305026858267273, 0.02865027715351493, 0.02422156381894531, 0.01987882992803311, 0.015734550007419856, 0.011896058730159377, 0.00846277100406604, 0.0055236071778226176, 0.0031546900506571104, 0.0014173733318282073, 0.00035665261178309955, 0.0],
        },
        "q2.I.-x90_Cosine.wf": {
            "type": "arbitrary",
            "samples": [0.0, -0.0006474868681043578, -0.002573177902642726, -0.005727198717339505, -0.010027861829824942, -0.015363782324520032, -0.021596762663442206, -0.02856537192984729, -0.03608912680417736, -0.04397316598723385, -0.05201329700547076, -0.060001284688802205, -0.06773024435212678, -0.07500000000000001, -0.08162226877976886, -0.08742553740855505, -0.09225950427718974, -0.09599897218294122, -0.0985470908713026, -0.0998378654067105, -0.09983786540671051, -0.0985470908713026, -0.09599897218294123, -0.09225950427718976, -0.08742553740855508, -0.08162226877976886, -0.07499999999999998, -0.06773024435212681, -0.060001284688802226, -0.05201329700547076, -0.043973165987233886, -0.0360891268041774, -0.028565371929847313, -0.021596762663442223, -0.015363782324520037, -0.010027861829824942, -0.0057271987173395, -0.0025731779026427204, -0.0006474868681043578, 0.0],
    ...
    "integration_weights": {
        "q1.resonator.readout.iw1": {
            "cosine": [(-0.9210232383746935, 2500)],
            "sine": [(-0.38950763070034006, 2500)],
        },
        "q1.resonator.readout.iw2": {
            "cosine": [(0.38950763070034006, 2500)],
            "sine": [(-0.9210232383746935, 2500)],
        },
        ...
        "q2.resonator.readout.iw1": {
            "cosine": [(0.9974142912737486, 2500)],
            "sine": [(0.07186606683884857, 2500)],
        },
        "q2.resonator.readout.iw2": {
            "cosine": [(-0.07186606683884857, 2500)],
            "sine": [(0.9974142912737486, 2500)],
        },
