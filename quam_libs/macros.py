...
def readout_state_gef(qubit : Transmon , state : QuaVariableType, pulse_name : str = 'readout', save_qua_var : StreamType = None):
    I = declare(fixed)
    Q = declare(fixed)
...
def active_reset(
    ...
    wait(qubit.resonator.depletion_time // 1, qubit.resonator.name)
