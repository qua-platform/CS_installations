...
def allXY(pulses):
    ...
    **Example:** I, Q = allXY(['I', 'y90'])
    ...
    if pulses[0] != "I":
        play(pulses[0], "q1_xy")  # Either play the sequence
    else:
        wait(pi_len >> 2, "q1_xy")  # or wait if sequence is identity
    # Play the 2nd gate or wait if the gate is identity
    if pulses[1] != "I":
        play(pulses[1], "q1_xy")  # Either play the sequence
    else:
        wait(pi_len >> 2, "q1_xy")  # or wait if sequence is identity
...
with program() as ALL_XY:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        wait(thermalization_time * u.ns, "q1_xy")
