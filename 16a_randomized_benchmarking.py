        ...
        with for_(depth, 1, depth <= max_circuit_depth, depth + 1):  # Loop over the depths
            ...
            with if_((depth == 1) | (depth == depth_target)):
                with for_(n, 0, n < n_avg, n + 1):  # Averaging loop
                    ...
                    align("q1_xy", "rr1")
                    # Make sure you updated the ge_threshold_q1 and angle if you want to use state discrimination
                    state, I, Q = readout_macro(threshold=ge_threshold_q1, state=state, I=I, Q=Q)
