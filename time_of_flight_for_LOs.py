...
if __name__ == "__main__":
    ...
    for rr_LO in rr_LOs:
        ...
        plt.suptitle(f"""
            ToF: LO = {rr_LO / u.GHz} GHz - MWSlot{mwfem_slot} Loopback [2M] AO{rr_ao_port}->AI{rr_ai_port}\n
        ...
        save_data_dict[f"{rl}_adc_LO={rr_LO/u.GHz:1.3f}GHz".replace(".", "-")] = adc1
        save_data_dict[f"{rl}_adc_single_LO={rr_LO/u.GHz:1.3f}GHz".replace(".", "-")] = adc1_single_run
    ...
    data_handler.save_data(data=save_data_dict, name="time_of_flight_for_LOs")
