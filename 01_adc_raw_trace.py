...
with program() as raw_trace_prog:
    ...
    with for_(n, 0, n < n_avg, n + 1):  # QUA for_ loop for averaging
        ...
        reset_phase("test")
        # Measure (send a readout pulse and record the raw ADC trace)
        measure("readout", "test", adc_st)
        # Wait for the resonator to deplete
        wait(depletion_time * u.ns, "test")
...
if simulate:
    ...
    save_data_dict.update({"adc1_single_run_data": adc1_single_run})
    save_data_dict.update({"adc1": adc1})
