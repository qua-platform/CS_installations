...
with program() as cpmg:
    ...
    # Spin initialization
    play("laser_ON", "AOM")
    wait(initialization_len * u.ns, "AOM")
...
if simulate:
    ...
    while results.is_processing():
        ...
        # Plot data
        plt.cla()
        plt.plot(taus_ns, counts_on_g, label="x90_idle_x180_idle_x90")
        plt.plot(taus_ns, counts_on_e, label="x90_idle_x180_idle_-x90")
        plt.plot(taus_ns, counts_off, label="mw off")
