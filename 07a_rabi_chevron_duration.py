...
Prerequisites:
    ...
    - Configuration of the qubit frequency and the desired pi pulse amplitude (labeled as "pi_amp_q1").

Before proceeding to the next node:
    - Adjust the qubit frequency setting, labeled as "qubit_IF_q1", in the configuration.
    - Modify the qubit pulse duration setting, labeled as "pi_len", in the configuration.
"""
