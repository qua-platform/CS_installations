...
from qualang_tools import octave_tools

# octave_tools.set_correction_parameters_to_opx()
###################
# The QUA program #
###################
...
with program() as reflectometry_spectro:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(f, frequencies)):
            ...
            measure("readout"*amp(0.1), "tank_circuit", None, demod.full("cos", I, "out2"), demod.full("sin", Q, "out2"))
            save(I, I_st)
            save(Q, Q_st)
