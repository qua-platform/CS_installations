...
# Relevant points in the charge stability map as ["Vd1", "Vd2"] in V
level_init = [0.005] #empty
level_manip = [-0.005] #load/wait
level_readout = [0.000] #readout
...
duration_init = 5000*u.ns
duration_manip = 5000*u.ns
duration_readout = 5000*u.ns
...
readout_len = duration_readout #+ duration_init + duration_manip
readout_amp = 0.1
...
Vd1_step_amp = 0.025  # in V
Vd2_step_amp = 0.025  # in V
Vd3_step_amp = 0.025  # in V
Vd4_step_amp = 0.025  # in V
charge_step_amp = 0.025 # in V
charge_sensor_amp = 0.025  # in V

# Time to ramp down to zero for sticky elements in ns
hold_offset_duration = 4  # in ns
bias_tee_cut_off_frequency = 4 * u.kHz
...
config = {
    ...
    "waveforms": {
        "Vd1_step_wf": {"type": "constant", "sample": Vd1_step_amp},
        "Vd2_step_wf": {"type": "constant", "sample": Vd2_step_amp},
        "Vd3_step_wf": {"type": "constant", "sample": Vd3_step_amp},
        "Vd4_step_wf": {"type": "constant", "sample": Vd4_step_amp},
