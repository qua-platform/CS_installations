...
Next steps before going to the next node:
    - Update the qubit frequency (qubit_IF_q1) in the configuration.
"""
...
with program() as ramsey:
    ...
    update_frequency("q1_xy", qubit_IF_q1 + detuning)
    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(tau, taus)):
            ...
            measure(
                ...
                "rr1",
                None,
                demod.full("rotated_cos", I, "out1"),
                demod.full("rotated_sin", Q, "out1"),
            )
...
if simulate:
    ...
    try:
        ...
        plt.xlabel("Idle time [ns]")
        plt.ylabel("I quadrature [V]")
        print(f"Qubit detuning to update in the config: qubit_IF_q1 += {-qubit_detuning:.0f} Hz")
