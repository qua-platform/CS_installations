...
@callable_from_qua
def set_dc_BILT(channel, voltage, progress_bar=None):
    """
    Set the DC voltage of a BILT channel to a specific value.

    :param channel: the BILT channel to set the voltage to.
    :param voltage: the voltage to set in Volts.
    :return:
    """

    # print(f"Setting BILT channel {channel} to {voltage} V.")
