...
###################################### CS RACK ####################################
## Link: https://quantum-machines.atlassian.net/wiki/spaces/CST/pages/2486566974/CS+Rack
## 172.16.33.101 (Admin Panel for CS_1, CS_2)
## 172.16.33.115 (Admin Panel for CS_3, CS_4, DGX)
###################################### CS RACK ####################################

qop_ip = ""  # Write the QM router IP address
cluster_name = ""  # Write your cluster_name if version >= QOP220
...
resonator_power = -11  # power in dBm at waveform amp = 1 (steps of 3 dB)
