...
sys.path.append("/Users/kalidu_laptop/TreQ_Test/CS_installations/HW_Calibration_Quam")
...
def QM_lf_freq_power_setup(
    ...
    QM_machine.add_dc_channel(
        port_id=QM_output, intermediate_frequency=frequency, output_mode=output_mode
    )

    QM_machine.add_dc_flux_pulse(
        port_id=QM_output, pulse_name="const_pulse", duration=10000, amplitude=maxamp
    )
