...
seq_instream = np.random.randint(low=0, high=10, size=seq_len).astype(int)
...
assert np.array_equal(seq_instream, seq_outstream), "input stream is not equal to output streams"
print("Success!")
