...
with program() as raw_trace_prog:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        # Reset the phase of the digital oscillator associated to pump_probe.
        reset_phase("pump_probe")
        # Sends the readout pulse and stores the raw ADC traces in the stream called "adc_st"
        measure("readout", "pump_probe", adc_st)
        # Wait for the magnet to thermalize
        wait(thermalization_time * u.ns, "pump_probe")

    with stream_processing():
        # save average all the traces:
