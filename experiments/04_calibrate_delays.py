...
def calibrate_delays(
    ...
    if mw_on:
        ...
        play("mw_ON", "MW_Switch", duration=mw_switch_len * u.ns)
...
if simulate:
    ...
    while results.is_processing():
        ...
        plt.cla()
        plt.plot(t_vec[::resolution] + resolution / 2, times_on_hist / 1000 / (resolution / u.s) / iterations)
        plt.plot(t_vec[::resolution] + resolution / 2, times_off_hist / 1000 / (resolution / u.s) / iterations)
        plt.xlabel("t [ns]")
