...
g = QualibrationGraph(
    ...
    nodes={
        "power_rabi": library.nodes["04_Power_Rabi"].copy(name="power_rabi"),
        ...
        "G_E_discrimination": library.nodes["07_IQ_Blobs"].copy(name="G_E_discrimination", reset_type_thermal_or_active='thermal'),
        "Power_rabi_error_amplification_x180": library.nodes["09_Power_Rabi_State"].copy(name="Power_rabi_error_amplification_x180", operation_x180_or_any_90 = "x180", reset_type_thermal_or_active = "active"),
        "Power_rabi_error_amplification_x90": library.nodes["09_Power_Rabi_State"].copy(name="Power_rabi_error_amplification_x90", operation_x180_or_any_90 = "x90", reset_type_thermal_or_active = "active"),
        ...
        "Ramsey_flux_cal": library.nodes["09d_Ramsey_flux_cal"].copy(name="Ramsey_flux_cal"),
        "Ramsey_flux_cal_2": library.nodes["09d_Ramsey_flux_cal"].copy(name="Ramsey_flux_cal_2"),
