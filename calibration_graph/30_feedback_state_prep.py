...
with program() as PROGRAM:
    ...
    with for_(n, 0, n < n_runs, n + 1):
        ...
        multiplexed_readout(I_g, None, Q_g, None, None, None, resonators, weights=weights)

        with while_(I_g[3] > -0.000109):
        ...
        multiplexed_readout(I_e, None, Q_e, None, None, None, resonators, weights=weights)

        with while_(I_e[3] < 0.000110):

            multiplexed_readout(I_e, None, Q_e, None, None, None, resonators, weights=weights)

            wait(120, 'q4_xy')
        
            with port_condition(I_e[3] < RR_CONSTANTS['q4_rr']["midcircuit_ge_threshold"]):
