...
with program() as prog:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        for q, qb in enumerate(qubits):
            assign(state[q], I[q] > qb.resonator.operations["readout"].threshold) # assuming 
    ...
    with stream_processing():
        ...
        for i in range(num_resonators):
            ...
            state_st[i].boolean_to_int().average().save(f"state{i + 1}")
