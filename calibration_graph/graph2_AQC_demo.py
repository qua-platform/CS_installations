...
g = QualibrationGraph(
    ...
    nodes={
        ...
        "power_rabi": library.nodes["03c_Power_Rabi"].copy(name="power_rabi"),
    ...
    connectivity=[("Resonator_spectroscopy", "Qubit_spectroscopy"), ("Qubit_spectroscopy", "power_rabi"), ("power_rabi", "Ramsey"), ("Ramsey", "Readout_freqeuncy_optimization"), ("Readout_freqeuncy_optimization", "G_E_discrimination"), ("G_E_discrimination", "Power_rabi_error_amplification_x180"), ("Power_rabi_error_amplification_x180", "Power_rabi_error_amplification_x90"), ("Power_rabi_error_amplification_x90", "Randomized_benchmarking")],
