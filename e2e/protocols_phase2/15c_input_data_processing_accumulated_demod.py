    ...
    with for_(n, 0, n < n_avg, n + 1):
        ...
        for i, rr in enumerate(resonators):
            ...
            measure(
                "readout",
                rr,
                demod.accumulated("cos", II[i], division_length, "out1"),
                demod.accumulated("sin", IQ[i], division_length, "out2"),
                demod.accumulated("minus_sin", QI[i], division_length, "out1"),
                demod.accumulated("cos", QQ[i], division_length, "out2"),
            )
