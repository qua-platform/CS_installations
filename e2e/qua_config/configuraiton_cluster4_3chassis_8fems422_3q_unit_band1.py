...
def print_elements_ports(qubits, resonators, jpas):
    ...
    if type(jpas) == list and len(jpas) >= 1:
        for jpa in jpas:
            ...
            print(f'{jpa} -> ({val["con"]}, fem {val["fem"]}, port {val["ao"]})')
...
QUBIT_PORT_MAP = {
    ...
    13: {"con": "con1", "fem": 4, "ao": 2, "thread": "q13"},
    14: {"con": "con1", "fem": 4, "ao": 3, "thread": "q14"},
    15: {"con": "con1", "fem": 4, "ao": 4, "thread": "q15"},
    16: {"con": "con1", "fem": 4, "ao": 5, "thread": "q16"},
    17: {"con": "con1", "fem": 4, "ao": 6, "thread": "q17"},
    18: {"con": "con1", "fem": 4, "ao": 7, "thread": "q18"},

    19: {"con": "con1", "fem": 5, "ao": 2, "thread": "q19"},
    20: {"con": "con1", "fem": 5, "ao": 3, "thread": "q20"},
    21: {"con": "con1", "fem": 5, "ao": 4, "thread": "q21"},
    22: {"con": "con1", "fem": 5, "ao": 5, "thread": "q22"},
    23: {"con": "con1", "fem": 5, "ao": 6, "thread": "q23"},
    24: {"con": "con1", "fem": 5, "ao": 7, "thread": "q24"},

    25: {"con": "con2", "fem": 1, "ao": 2, "thread": "q25"},
    26: {"con": "con2", "fem": 1, "ao": 3, "thread": "q26"},
    27: {"con": "con2", "fem": 1, "ao": 4, "thread": "q27"},
    28: {"con": "con2", "fem": 1, "ao": 5, "thread": "q28"},
    29: {"con": "con2", "fem": 1, "ao": 6, "thread": "q29"},
    30: {"con": "con2", "fem": 1, "ao": 7, "thread": "q30"},

    31: {"con": "con2", "fem": 2, "ao": 2, "thread": "q31"},
    32: {"con": "con2", "fem": 2, "ao": 3, "thread": "q32"},
    33: {"con": "con2", "fem": 2, "ao": 4, "thread": "q33"},
    34: {"con": "con2", "fem": 2, "ao": 5, "thread": "q34"},
    35: {"con": "con2", "fem": 2, "ao": 6, "thread": "q35"},
    # 36: {"con": "con2", "fem": 2, "ao": 7, "thread": "q36"},

    36: {"con": "con3", "fem": 1, "ao": 2, "thread": "q36"},
    37: {"con": "con3", "fem": 1, "ao": 3, "thread": "q37"},
    38: {"con": "con3", "fem": 1, "ao": 4, "thread": "q38"},
    39: {"con": "con3", "fem": 1, "ao": 5, "thread": "q39"},
    40: {"con": "con3", "fem": 1, "ao": 6, "thread": "q40"},
    41: {"con": "con3", "fem": 1, "ao": 7, "thread": "q41"},

    42: {"con": "con3", "fem": 2, "ao": 2, "thread": "q42"},
    43: {"con": "con3", "fem": 2, "ao": 3, "thread": "q43"},
    44: {"con": "con3", "fem": 2, "ao": 4, "thread": "q44"},
    45: {"con": "con3", "fem": 2, "ao": 5, "thread": "q45"},
    46: {"con": "con3", "fem": 2, "ao": 6, "thread": "q46"},
    # 47: {"con": "con3", "fem": 2, "ao": 7, "thread": "q47"},
}
...
RL_PORT_MAP = {
    ...
    5:  {"con": "con1", "fem": 4, "ao": 1, "ai": 1},
    6:  {"con": "con1", "fem": 4, "ao": 8, "ai": 2},
    7:  {"con": "con1", "fem": 5, "ao": 1, "ai": 1},
    8:  {"con": "con1", "fem": 5, "ao": 8, "ai": 2},

    9:  {"con": "con2", "fem": 1, "ao": 1, "ai": 1},
    10:  {"con": "con2", "fem": 1, "ao": 8, "ai": 2},
    11:  {"con": "con2", "fem": 2, "ao": 1, "ai": 1},
    12:  {"con": "con2", "fem": 2, "ao": 8, "ai": 2},

    13:  {"con": "con3", "fem": 1, "ao": 1, "ai": 1},
    14:  {"con": "con3", "fem": 1, "ao": 8, "ai": 2},
    15:  {"con": "con3", "fem": 2, "ao": 1, "ai": 1},
    16:  {"con": "con3", "fem": 2, "ao": 8, "ai": 2},
}
...
JPA_PORT_MAP = {
    1:  {"con": "con2", "fem": 2, "ao": 7, "thread": "j1", "amp": 1.0},
    2:  {"con": "con3", "fem": 2, "ao": 7, "thread": "j2", "amp": 1.0},
    ...
    # 8:  {"con": "con3", "fem": 1, "ao": 8, "thread": "j8", "amp": 1.0},
