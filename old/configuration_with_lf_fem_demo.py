...
#####################
con = "con1"
mw_fem = 1  # Should be the MW-FEM index, e.g., 1
...
# reflectometry_readout_long_length = 1000 * u.us
        ...
        con: {
            ...
            "fems": {
                ...
                lf_fem: {
                    ...
                    "analog_inputs": {
                        1: {
                            # "offset": -0.0030887304687500002 - 0.0062728076171875,
                            "offset": 0.110509,
                            "gain_db": 10,
