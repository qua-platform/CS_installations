...
qubit_LO_q1 = (
    5.25 * u.GHz
)  # Used only for mixer correction and frequency rescaling for plots or computation
qubit_LO_q2 = (
    5.25 * u.GHz
)  # Used only for mixer correction and frequency rescaling for plots or computation
...
assert (
    abs(qubit_IF_q1_ef) <= 350 * u.MHz
), "qubit_IF_q1_ef is out of range [-350, +350] MHz"
assert (
    abs(qubit_IF_q2_ef) <= 350 * u.MHz
), "qubit_IF_q2_ef is out of range [-350, +350] MHz"
assert (
    abs(qubit_IF_cr_c1t2) <= 350 * u.MHz
), "qubit_IF_cr_c1t2 is out of range [-350, +350] MHz"
assert (
    abs(qubit_IF_cr_c2t1) <= 350 * u.MHz
), "qubit_IF_cr_c2t1 is out of range [-350, +350] MHz"
...
x180_wf_q1, x180_der_wf_q1 = np.array(
    drag_gaussian_pulse_waveforms(pi_amp_q1, *drag_params_q1)
)
x180_I_wf_q1 = x180_wf_q1
x180_Q_wf_q1 = x180_der_wf_q1
# q2
x180_wf_q2, x180_der_wf_q2 = np.array(
    drag_gaussian_pulse_waveforms(pi_amp_q2, *drag_params_q2)
)
...
x90_wf_q1, x90_der_wf_q1 = np.array(
    drag_gaussian_pulse_waveforms(pi_amp_q1 / 2, *drag_params_q1)
)
x90_I_wf_q1 = x90_wf_q1
x90_Q_wf_q1 = x90_der_wf_q1
# q2
x90_wf_q2, x90_der_wf_q2 = np.array(
    drag_gaussian_pulse_waveforms(pi_amp_q2 / 2, *drag_params_q2)
)
...
def get_flattop_rise_fall_amp(rise_fall_len, flattop_len, flattop_amp):
    ...
    # rise
    rise_flattop = flattop_gaussian_waveform(
        flattop_amp, flattop_len, rise_fall_len, return_part="rise"
    )
    rise_flattop_amps = np.array(zero_pad + rise_flattop)
    # fall
    fall_flattop = flattop_gaussian_waveform(
        flattop_amp, flattop_len, rise_fall_len, return_part="fall"
    )
...
(
    cr_c1t2_flattop_amps,
    cr_c1t2_rise_flattop_amps,
    cr_c1t2_fall_flattop_amps,
) = get_flattop_rise_fall_amp(
    cr_c1t2_rise_fall_len, cr_c1t2_flattop_len, cr_c1t2_flattop_amp
)
...
(
    cr_c2t1_flattop_amps,
    cr_c2t1_rise_flattop_amps,
    cr_c2t1_fall_flattop_amps,
) = get_flattop_rise_fall_amp(
    cr_c2t1_rise_fall_len, cr_c2t1_flattop_len, cr_c2t1_flattop_amp
)
...
(
    cr_cancel_c1t2_flattop_amps,
    cr_cancel_c1t2_rise_flattop_amps,
    cr_cancel_c1t2_fall_flattop_amps,
) = get_flattop_rise_fall_amp(
    cr_cancel_c1t2_rise_fall_len, cr_cancel_c1t2_flattop_len, cr_cancel_c1t2_flattop_amp
)
...
(
    cr_cancel_c2t1_flattop_amps,
    cr_cancel_c2t1_rise_flattop_amps,
    cr_cancel_c2t1_fall_flattop_amps,
) = get_flattop_rise_fall_amp(
    cr_cancel_c2t1_rise_fall_len, cr_cancel_c2t1_flattop_len, cr_cancel_c2t1_flattop_amp
)
...
config = {
    ...
    "waveforms": {
        ...
        "cr_c1t2_square_positive_wf": {
            "type": "constant",
            "sample": cr_c1t2_square_positive_amp,
        },
        "cr_c2t1_square_positive_wf": {
            "type": "constant",
            "sample": cr_c2t1_square_positive_amp,
        },
        "cr_c1t2_square_negative_wf": {
            "type": "constant",
            "sample": cr_c1t2_square_negative_amp,
        },
        "cr_c2t1_square_negative_wf": {
            "type": "constant",
            "sample": cr_c2t1_square_negative_amp,
        },
        "cr_c1t2_flattop_wf": {"type": "constant", "sample": cr_c1t2_flattop_amp},
        "cr_c2t1_flattop_wf": {"type": "constant", "sample": cr_c2t1_flattop_amp},
        "cr_c1t2_gaussian_rise_wf": {
            "type": "arbitrary",
            "samples": cr_c1t2_rise_flattop_amps.tolist(),
        },
        "cr_c2t1_gaussian_rise_wf": {
            "type": "arbitrary",
            "samples": cr_c2t1_rise_flattop_amps.tolist(),
        },
        "cr_c1t2_gaussian_fall_wf": {
            "type": "arbitrary",
            "samples": cr_c1t2_fall_flattop_amps.tolist(),
        },
        "cr_c2t1_gaussian_fall_wf": {
            "type": "arbitrary",
            "samples": cr_c2t1_fall_flattop_amps.tolist(),
        },
        "cr_cancel_c1t2_square_positive_wf": {
            "type": "constant",
            "sample": cr_cancel_c1t2_square_positive_amp,
        },
        "cr_cancel_c2t1_square_positive_wf": {
            "type": "constant",
            "sample": cr_cancel_c2t1_square_positive_amp,
        },
        "cr_cancel_c1t2_square_negative_wf": {
            "type": "constant",
            "sample": cr_cancel_c1t2_square_negative_amp,
        },
        "cr_cancel_c2t1_square_negative_wf": {
            "type": "constant",
            "sample": cr_cancel_c2t1_square_negative_amp,
        },
        "cr_cancel_c1t2_flattop_wf": {
            "type": "constant",
            "sample": cr_cancel_c1t2_flattop_amp,
        },
        "cr_cancel_c2t1_flattop_wf": {
            "type": "constant",
            "sample": cr_cancel_c2t1_flattop_amp,
        },
        "cr_cancel_c1t2_gaussian_rise_wf": {
            "type": "arbitrary",
            "samples": cr_cancel_c1t2_rise_flattop_amps.tolist(),
        },
        "cr_cancel_c2t1_gaussian_rise_wf": {
            "type": "arbitrary",
            "samples": cr_cancel_c2t1_rise_flattop_amps.tolist(),
        },
        "cr_cancel_c1t2_gaussian_fall_wf": {
            "type": "arbitrary",
            "samples": cr_cancel_c1t2_fall_flattop_amps.tolist(),
        },
        "cr_cancel_c2t1_gaussian_fall_wf": {
            "type": "arbitrary",
            "samples": cr_cancel_c2t1_fall_flattop_amps.tolist(),
        },
        ...
        "minus_x90_I_wf_q1": {
            "type": "arbitrary",
            "samples": minus_x90_I_wf_q1.tolist(),
        },
        "minus_x90_Q_wf_q1": {
            "type": "arbitrary",
            "samples": minus_x90_Q_wf_q1.tolist(),
        },
        ...
        "minus_y90_I_wf_q1": {
            "type": "arbitrary",
            "samples": minus_y90_I_wf_q1.tolist(),
        },
        "minus_y90_Q_wf_q1": {
            "type": "arbitrary",
            "samples": minus_y90_Q_wf_q1.tolist(),
        },
        ...
        "minus_x90_I_wf_q2": {
            "type": "arbitrary",
            "samples": minus_x90_I_wf_q2.tolist(),
        },
        "minus_x90_Q_wf_q2": {
            "type": "arbitrary",
            "samples": minus_x90_Q_wf_q2.tolist(),
        },
        ...
        "minus_y90_I_wf_q2": {
            "type": "arbitrary",
            "samples": minus_y90_I_wf_q2.tolist(),
        },
        "minus_y90_Q_wf_q2": {
            "type": "arbitrary",
            "samples": minus_y90_Q_wf_q2.tolist(),
        },
