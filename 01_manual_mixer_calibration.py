...
# qm.set_mixer_correction('mixer_qubit', int(qubit_IF_q1), int(qubit_LO_q1), IQ_imbalance(0.015, 0.01))
...
# This can be achieved by changing the line above to `play("cw" * amp(0), "q1_xy")`
