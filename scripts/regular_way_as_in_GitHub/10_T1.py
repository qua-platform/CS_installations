...
with program() as T1:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(t, t_vec)):
            ...
            play("laser_ON", "AOM")
            measure("readout", "APD", None, time_tagging.analog(times_dark, meas_len, counts_dark))
...
if simulate:
    ...
    while results.is_processing():
        ...
        # Plot data
        plt.cla()
        plt.plot(4 * t_vec, counts1 / 1000 / (meas_len / u.s), label="counts in |0>")
        plt.plot(4 * t_vec, counts2 / 1000 / (meas_len / u.s), label="counts in |1>")
