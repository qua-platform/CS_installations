...
with program() as power_rabi:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(a, a_vec)):
            ...
            play("laser_ON", "AOM", duration=initialization_len * u.ns + 100 * u.ns) # adding 100ns for some extra buffer time
            ...
            if wait_pulse_time_for_background_measuremenets:
                # Play the Rabi pulse with varying amplitude
                play("x180" * amp(0), "NV")  # 'a' is a pre-factor to the amplitude defined in the config ("mw_amp_NV")
