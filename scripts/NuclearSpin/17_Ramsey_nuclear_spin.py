...
# The QUA program #
###################
with program() as ramsey_nuclear_spin:
...
if simulate:
    ...
    job = qmm.simulate(config, ramsey_nuclear_spin, simulation_config)
    ...
    job = qm.execute(ramsey_nuclear_spin)
    ...
    while results.is_processing():
        ...
        # Plot data
        plt.cla()
        plt.plot(4 * t_vec, counts1 / 1000 / (meas_len / u.s), label="x90_idle_x90")
