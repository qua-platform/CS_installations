...
from configuration_with_lf_fem import config
...
from test_tools.remotes import CS_3_remote

qop_ip = CS_3_remote["host"]
cluster_name = CS_3_remote["cluster_name"]
