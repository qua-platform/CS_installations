...
Next steps before going to the next node:
    - Update the initial laser delay (laser_delay) and initialization length (initialization_len_1) in the configuration.
    - Update the delay between the laser and mw (mw_delay) and the mw length (mw_len) in the configuration.
    - Update the measurement length (meas_len) in the configuration.
"""
