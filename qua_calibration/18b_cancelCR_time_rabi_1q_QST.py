...
n_avg = 200
cr_drive_amp = 0.03 / 3 # ratio
cr_drive_phase = -0.4 + 0.0  # in units of 2pi
cr_cancel_amp = -0.000 / 3  # ratio
cr_cancel_phase = 0.0 + 0.0 # in units of 2pi
ts_cycles = np.arange(4, 200, 4)  # in clock cylcle = 4ns
# ts_cycles = np.arange(4, 500, 4)  # in clock cylcle = 4ns
