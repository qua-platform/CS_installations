...
if simulate:
    ...
    try:
        ...
        # Plot for single run
        plt.subplot(121)
        plt.title(f"Resonator {resonator} Single run")
        ...
        plt.subplot(122)
        plt.title(f"Resonator {resonator} Average run")
        ...
        save_data_dict.update({"adc1.real_avg": adc1.real})
        save_data_dict.update({"adc1.imag_avg": adc1.imag})
