...
def bake_cnot(baker: Baking, q1, q2):
    ...
    baker.wait(cr_drive_len, qc_xy)
    baker.wait(cr_drive_len, qt_xy)
    # echo
...
rb = TwoQubitRb(
    ...
    prep_func=prep,
    measure_func=meas,
    interleaving_gate=None, # interleaving_gate=[cirq.CZ(cirq.LineQubit(0), cirq.LineQubit(1))],
    verify_generation=False,
)

qmm = QuantumMachinesManager(host=qop_ip, cluster_name=cluster_name) # initialize qmm
