...
def plot_ar_attempts(ar_data: dict[str, np.typing.NDArray], **hist_kwargs):
    ...
    Example:
        ...
        from lib.plot_utils import plot_ar_attempts
        ar_dat = {}
...
class QubitPairGrid():
    ...
    '''
    from lib.qua_datasets import grid_iter
...
class QubitGrid():
    ...
    '''
    from lib.qua_datasets import grid_iter, QubitGrid
    grid = QubitGrid(ds)
    ...
    '''
    from lib.qua_datasets import grid_iter, QubitGrid, grid_names
    ...
    def __init__(self, ds: xr.DataArray, grid_names: list = None, size : int = 2):
        if grid_names:
