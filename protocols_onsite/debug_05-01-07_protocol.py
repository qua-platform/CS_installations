...
# Single QUA script generated at 2025-03-19 03:57:56.705239
...
with program() as prog:
    ...
    v5 = declare(fixed, )
    v6 = declare(fixed, )
    with for_(v2,0,(v2<100),(v2+1)):
        measure("readout", "resonator_con1-fem1-port1-duc1", dual_demod.full("cos", "sin", v3), dual_demod.full("minus_sin", "cos", v5))
        align("resonator_con1-fem1-port1-duc1", "qubit_con1-fem1-port3-duc1")
        with port_condition((v3>-1)):
            play("x180", "qubit_con1-fem1-port3-duc1")
        wait(250, "resonator_con1-fem1-port1-duc1")
        measure("readout", "resonator_con1-fem1-port2-duc1", dual_demod.full("cos", "sin", v4), dual_demod.full("minus_sin", "cos", v6))
        align("resonator_con1-fem1-port2-duc1", "qubit_con1-fem1-port4-duc1")
        with port_condition((v4>-1)):
            play("x180", "qubit_con1-fem1-port4-duc1")
        wait(250, "resonator_con1-fem1-port2-duc1")
