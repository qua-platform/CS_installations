...
# Single QUA script generated at 2025-03-19 03:56:29.621367
...
with program() as prog:
    ...
    with for_(v2,0,(v2<100),(v2+1)):
        measure("readout", "resonator_con1-fem1-port1-duc1", dual_demod.full("cos", "sin", v5), dual_demod.full("minus_sin", "cos", v7))
        align("resonator_con1-fem1-port1-duc1", "qubit_con1-fem1-port2-duc1")
        with if_((v7>0)):
            assign(v3, 1)
        with else_():
            assign(v3, 0)
        ...
        measure("readout", "resonator_con1-fem2-port1-duc1", dual_demod.full("cos", "sin", v6), dual_demod.full("minus_sin", "cos", v8))
        align("resonator_con1-fem2-port1-duc1", "qubit_con1-fem2-port2-duc1")
        with if_((v8>0)):
            assign(v3, 1)
        with else_():
            assign(v3, 0)
        assign(v4, (v6>v3))
        wait(250, "resonator_con1-fem2-port1-duc1")
