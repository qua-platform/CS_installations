"""
QUA-Config supporting OPX1000 w/ LF-FEM and MW-FEM
"""
...
config = {
        ...
        con: {
            ...
            "fems": {
                ...
                mwfem: {
                    "type": "MW",
                    "analog_outputs": {
                        #An example MW analog output; Potentially barrier B4
                        1: {
                            "band" : 1,
                            "full_scale_power_dbm" : 10,
                            "upconverters":{
                                1: {"frequency": 1e9} #Min 750MHz
                            }
                        }
                    }, 
                    "digital_outputs" : {
                        #An example MW digital output
                        1 : {}
                    }, 
                    "analog_inputs": {
                        #An example analog input, coupled to output port 1 of the MW FEM
                        1: {"band": 1, "downconverter_frequency": 1e9}
                    }
                }
            },
        }
    ...
    "elements": {
        ...
        "TIA": {
            ...
            "outputs": {
                "out1": (con, lffem1, 1), ## Is this the right LF FEM? 
                "out2": (con, lffem1, 2),
            },
            "time_of_flight": time_of_flight,
            "smearing": 0,
