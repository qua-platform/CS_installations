...
Next steps before going to the next node:
    ...
    - Update the g -> e threshold (ge_threshold_q1) in the configuration.
"""
...
with program() as IQ_blobs:
    ...
    with for_(n, 0, n < n_runs, n + 1):
        ...
        measure(
            ...
            "rr1",
            None,
            demod.full("cos", I_g, "out1"),
            demod.full("sin", Q_g, "out1"),
        )
        ...
        measure(
            ...
            "rr1",
            None,
            demod.full("cos", I_e, "out1"),
            demod.full("sin", Q_e, "out1"),
        )
...
if simulate:
    ...
    #
    # # Active reset (faster):
    # play("x180", "q1_xy", condition=I > threshold)
    #
    #########################################
    #
