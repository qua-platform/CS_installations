...
with program() as TimeTagging_calibration:
    ...
    with for_(n, 0, n < n_avg, n + 1):  # QUA for_ loop for averaging
        ...
        measure("readout", "readout_element", adc_stream = adc_st)
        # Waits for the
...
if simulate:
    ...
    adc1 = u.raw2volts(res_handles.get("adc2").fetch_all())
    adc1_single_run = u.raw2volts(res_handles.get("adc2_single_run").fetch_all())
    # Plot data
    plt.figure()
    plt.subplot(121)
