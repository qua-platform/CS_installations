"""
A script that changes the duration of the pulses send to the qubit to determine
...
with program() as pi_pulse_cal:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(pulse1_len, pulse1_vec)):
            ...
            # we reset_phase the 'qubit' to be able to collect signals with 'resonator'
            ...
            # 'qubit' and demodulated in 'resonator', we reset the phase of the 'resonator'
            ...
            wait(readout_delay, "readout_element") #, "switch_receiver")
            # Readout
...
if simulate:
    ...
    ver_t2 = get_c2c_time(job, ("qubit", 2), ("readout_element", 0))
    print(
