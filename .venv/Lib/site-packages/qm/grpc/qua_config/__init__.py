...
class QuaConfigVoltageLevel(betterproto.Enum):
    LVTTL = 0
    TTL = 1
...
class QuaConfigFemTypes(betterproto.Message):
    ...
    microwave: "QuaConfigMicrowaveFemDec" = betterproto.message_field(
        3, group="fem_type_one_of"
    )
...
@dataclass(eq=False, repr=False)
class QuaConfigMicrowaveFemDec(betterproto.Message):
    analog_outputs: Dict[
        int, "QuaConfigMicrowaveAnalogOutputPortDec"
    ] = betterproto.map_field(2, betterproto.TYPE_UINT32, betterproto.TYPE_MESSAGE)
    analog_inputs: Dict[
        int, "QuaConfigMicrowaveAnalogInputPortDec"
...
@dataclass(eq=False, repr=False)
class QuaConfigMicrowaveAnalogOutputPortDec(betterproto.Message):
    sampling_rate: float = betterproto.double_field(1)
    full_scale_power_dbm: int = betterproto.int32_field(2)
    band: int = betterproto.int32_field(3)
    delay: int = betterproto.uint32_field(4)
    shareable: bool = betterproto.bool_field(5)


@dataclass(eq=False, repr=False)
class QuaConfigMicrowaveAnalogInputPortDec(betterproto.Message):
    sampling_rate: float = betterproto.double_field(1)
    gain_db: int = betterproto.int32_field(2)
    shareable: bool = betterproto.bool_field(3)
    band: int = betterproto.int32_field(4)
...
class QuaConfigAnalogInputPortDec(betterproto.Message):
    ...
    shareable: bool = betterproto.bool_field(3)
    sampling_rate: Optional[float] = betterproto.double_field(
        4, optional=True, group="_samplingRate"
    )
...
class QuaConfigDigitalOutputPortDec(betterproto.Message):
    ...
    level: Optional["QuaConfigVoltageLevel"] = betterproto.enum_field(
        3, optional=True, group="_level"
    )
...
@dataclass(eq=False, repr=False)
class QuaConfigMultipleOutputs(betterproto.Message):
    port_references: Dict[str, "QuaConfigAdcPortReference"] = betterproto.map_field(
        1, betterproto.TYPE_STRING, betterproto.TYPE_MESSAGE
    )
...
class QuaConfigElementDec(betterproto.Message):
    ...
    microwave_input: "QuaConfigMicrowaveInputPortReference" = betterproto.message_field(
        52, group="element_inputs_one_of"
    )
    microwave_output: "QuaConfigMicrowaveOutputPortReference" = (
        betterproto.message_field(53, group="element_outputs_one_of")
    )
    multiple_outputs: "QuaConfigMultipleOutputs" = betterproto.message_field(
        54, group="element_outputs_one_of"
    )
    ...
    def __post_init__(self) -> None:
        ...
        if self.is_set("outputs"):
            warnings.warn(
                "QuaConfigElementDec.outputs is deprecated", DeprecationWarning
            )
        if self.is_set("intermediate_frequency"):
            warnings.warn(
...
@dataclass(eq=False, repr=False)
class QuaConfigMicrowaveInputPortReference(betterproto.Message):
    port: "QuaConfigDacPortReference" = betterproto.message_field(1)
    oscillator_frequency_hz: float = betterproto.double_field(2)


@dataclass(eq=False, repr=False)
class QuaConfigMicrowaveOutputPortReference(betterproto.Message):
