...
class QuaProgramUpdateOscillatorFrequencyStatementUnits(betterproto.Enum):
    GHz = 0
    MHz = 1
    KHz = 2
    Hz = 3
...
class QuaProgramUpdateOscillatorFrequencyStatementUpdateComponentSelection(
    betterproto.Enum
):
    both = 0
    upconverter = 1
...
class QuaProgram(betterproto.Message):
    ...
    config_update: "_qua_config__.QuaConfig" = betterproto.message_field(8)
...
class QuaProgramAnyStatement(betterproto.Message):
    ...
    update_oscillator_frequency: "QuaProgramUpdateOscillatorFrequencyStatement" = (
        betterproto.message_field(25, group="statement_oneof")
    )
...
class QuaProgramPlayStatement(betterproto.Message):
    ...
    port_condition: "QuaProgramAnyScalarExpression" = betterproto.message_field(12)
...
@dataclass(eq=False, repr=False)
class QuaProgramUpdateOscillatorFrequencyStatement(betterproto.Message):
    loc: str = betterproto.string_field(100)
    qe: "QuaProgramQuantumElementReference" = betterproto.message_field(1)
    value: "QuaProgramAnyScalarExpression" = betterproto.message_field(2)
    units: "QuaProgramUpdateOscillatorFrequencyStatementUnits" = betterproto.enum_field(
        3
    )
    keep_phase: bool = betterproto.bool_field(4)
    update_component: "QuaProgramUpdateOscillatorFrequencyStatementUpdateComponentSelection" = betterproto.enum_field(
        5
    )
