...
Prerequisites:
    ...
    - Set the desired pi pulse duration, labeled as "mw_len", in the configuration
...
if simulate:
    ...
    while results.is_processing():
        ...
        # Plot data
        plt.cla()
        plt.plot(amps * pi_amp, counts_on, label="mw on")
        plt.plot(amps * pi_amp, counts_off, label="mw off")
