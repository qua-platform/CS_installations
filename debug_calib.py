...
with program() as prog:
    ...
    with while_(v35):
        ...
        measure(
            ...
            None,
            dual_demod.full("integW_cos", "integW_sin", v3),
            dual_demod.full("integW_minus_sin", "integW_cos", v1),
        )
        measure(
            "Analyze",
            "__oct__oct1_1_image_analyzer",
            None,
            dual_demod.full("integW_cos", "integW_sin", v4),
            dual_demod.full("integW_minus_sin", "integW_cos", v2),
        )
    ...
    with stream_processing():
        lo_st.average().save("lo")
        im_st.average().save("im")
...
config = {
    ...
    "waveforms": {
        ...
        "qubit_xy.x180.wf.I": {
            ...
            "samples": [
                0.0,
                0.007460108018703365,
                0.015031875129355693,
                0.02247975961775374,
                0.029545159612914956,
                0.03596063878135093,
                0.04146637828294318,
                0.045827482636353806,
                0.0488505495426262,
            ]
            + [0.050397880757583724] * 2
            + [
                0.0488505495426262,
                0.045827482636353806,
                0.04146637828294318,
