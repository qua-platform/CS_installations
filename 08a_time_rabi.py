...
Prerequisites:
    ...
    - Set the qubit frequency and desired pi pulse amplitude (pi_amp_q1) in the configuration.

Next steps before going to the next node:
    - Update the qubit pulse duration (pi_len) in the configuration.
"""
...
if simulate:
    ...
    try:
        ...
        plt.xlabel("Rabi pulse duration [ns]")
        plt.ylabel("I quadrature [V]")
        print(f"Optimal pi_len = {round(1 / rabi_fit['f'][0] / 2 / 4) * 4} ns for {pi_amp_q1:} V")
    except (Exception,):
        pass
