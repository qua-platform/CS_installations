...
with program() as continuous_demodulation:
    ...
    assign_variables_to_element("dc_readout_element_twin", dc_signal[1])

    # Play a long pulse to record
    wait(100 * u.ms, "lf_readout_element_twin")
    update_frequency("lf_readout_element_twin", 1_000)
    play("readout", "lf_readout_element_twin", duration=1 * u.s)
    ...
    # 2nd readout
    wait(readout_len * u.ns+4,  "dc_readout_element_twin")
