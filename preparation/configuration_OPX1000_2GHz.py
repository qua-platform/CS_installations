        ...
        "con1": {
            ...
            "fems": {
                ...
                3: {
                    "type": "LF",
                    "analog_outputs": {
                        1: {"offset": 0.0, "sampling_rate": 2e9, "output_mode": "direct", "delay": 0},  # , "filter": {"feedforward": [], "feedback": []}
                        2: {"offset": 0.0, "sampling_rate": 2e9, "output_mode": "amplified", "delay": 0},
                        3: {"offset": 0.0, "sampling_rate": 2e9, "output_mode": "direct", "delay": 0},
                        4: {"offset": 0.0, "sampling_rate": 2e9, "output_mode": "amplified", "delay": 0},
                    },
                    "analog_inputs": {
                        1: {"offset": 0.000358, "sampling_rate": int(2e9), "gain_db": 0},
                        2: {"offset": -0.00712, "sampling_rate": int(2e9), "gain_db": 0},
