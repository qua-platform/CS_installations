...
if __name__ == "__main__":
    ...
    if simulate:
        ...
        try:
            ...
            plt.plot(adc0_single_run.real, label="Input real")
            plt.plot(adc0_single_run.imag, label="Input image")
            plt.axhline(y=0)
            plt.xlabel("Time [ns]")
            ...
            plt.plot(adc0.real, label="Input real")
            plt.plot(adc0.imag, label="Input imag")
            plt.axhline(y=0)
            plt.xlabel("Time [ns]")
            plt.legend()
            plt.tight_layout()
