...
if simulate:
    ...
    for _n_shots in list_n_shots:
        ...
        for i_row, (_, row) in enumerate(this_df.iterrows()):
            ...
            _log_this = f"{current_datetime_str}, n_shots: {_n_shots}, no: {i_row + 1}, seq_len: {seq_len}, circ_idx = {C}, n_circuits: P={P}, G={G}, d={d}, M={M}, Ph4={Ph4}, Ph={Ph}, elapsed_secs: {elapsed_time_secs}"
            print(_log_this)
