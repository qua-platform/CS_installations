...
rr_if = np.array([-226808736, 40522726])
rr_LO = 7.38 * u.GHz
rr_freq = rr_LO + rr_if  # The intermediate frequency is inferred from the LO and readout frequencies
rr_max_power_dBm = -11
...
xy_if = np.array([177461563, 298582486])
xy_LO = np.array([4.80, 5.59]) * u.GHz
xy_freq = xy_LO + xy_if  # The intermediate frequency is inferred from the LO and qubit frequencies
...
anharmonicity = np.array([200000000, 205500000])
