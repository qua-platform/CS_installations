...
wait_for_initialization = 10_000
#############################################
#                  Qubits                   #
#############################################
qubit_LO = 6 * u.GHz
...
safe_delay = u.to_clock_cycles(2 * u.us)  # Delay to safely avoid pulses during readout window

signal_threshold_1 = 500
counter_len = 1000 #Cannot use unit class modifier for durations that are input arguments into time-tagging measure command
...
config = {
    ...
    "controllers": {
        con: {
            "analog_outputs": {
                1: {"offset": 0.0},  # I
                2: {"offset": 0.0},  # Q
                3: {"offset": 0.0},  # JPA Pump 
                4: {"offset": 0.0},  # AMP Pump
                9: {"offset": 0.0}
            },
            "digital_outputs": {
                1: {}, #TTL1
                2: {}, #TTL1
                3: {}, #Used for simulation
            },
            "analog_inputs": {
    ...
    "waveforms": {
        ...
        "const_wf_JPA": {"type": "constant", "sample": JPA_amp},
        "const_wf_AMP": {"type": "constant", "sample": AMP_amp},
        ...
        "const_wf_readout": {"type": "constant", "sample": readout_amp},
    },
    "digital_waveforms": {
        "ON": {"samples": [(1, 0)]},
    },
        ...
        "mixer_JPA": [
            {
                "intermediate_frequency": JPA_IF,
                "lo_frequency": JPA_LO,
                "correction": IQ_imbalance(mixer_JPA_g, mixer_JPA_phi),
            }
        ],
        "mixer_AMP": [
            {
                "intermediate_frequency": AMP_IF,
                "lo_frequency": AMP_LO,
                "correction": IQ_imbalance(mixer_AMP_g, mixer_AMP_phi),
            }
        ],
    },
}
