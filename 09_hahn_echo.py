...
with program() as hahn_echo:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(t, t_vec)):
            ...
            play("laser_ON", "AOM")
            measure("readout", "APD", None, time_tagging.analog(times1, meas_len_1, counts1))
            ...
            # Measure and detect the photons on APD
            play("laser_ON", "AOM")
            measure("readout", "APD", None, time_tagging.analog(times2, meas_len_1, counts2))
            ...
            play("laser_ON", "AOM")
            measure("readout", "APD", None, time_tagging.analog(times_dark, meas_len_1, counts_dark))
...
if simulate:
    ...
    while results.is_processing():
        ...
        data_handler.save_data(data=save_data_dict, name="hahn_echo")