    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(f, dfs)):
            ...
            with for_(*from_array(dc, flux)):
                ...
                play("const"*amp((dc/const_flux_amp)),'flux_line',duration = (flux_settle_time*u.ns+ readout_len*u.ns))
                wait((flux_settle_time-delay)*u.ns, "resonator")
