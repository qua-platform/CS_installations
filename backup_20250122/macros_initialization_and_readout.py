...
sweep_gates = ["P0_sticky", "P1_sticky", "P2_sticky", "P3_sticky", "P4_sticky"]
barrier_gates = ["B2"]
...
level_inits = {
    "P0-P1": [-0.05, 0.05, 0.0, 0.0, 0.0],
    "P2": [0.0, 0.0, -0.05, 0.0, 0.0],
    "P3-P4": [0.0, 0.0, 0.0, -0.06, 0.04],
}
level_readouts = {
    "P0-P1": [-0.01, 0.01, 0.0, 0.0, 0.0],
    "P2": [-0.01, 0.01, 0.0, 0.0, 0.0],
    "P3-P4": [0.0, 0.0, 0.0, -0.01, 0.01],
}
...
seq.add_points("initialization_1q_P1-P2", level_inits["P0-P1"], duration_init_1q)
seq.add_points("initialization_1q_P4-P5", level_inits["P3-P4"], duration_init_1q)
seq.add_points("initialization_1q_P3", level_inits["P2"], duration_init_1q)

seq.add_points("initialization_2q_P1-P2", level_inits["P0-P1"], duration_init_2q)
seq.add_points("initialization_2q_P4-P5", level_inits["P3-P4"], duration_init_2q)
seq.add_points("initialization_2q_P3", level_inits["P2"], duration_init_2q)

seq.add_points("readout_P1-P2", level_readouts["P0-P1"], duration_readout)
seq.add_points("readout_P3", level_readouts["P2"], duration_readout)
seq.add_points("readout_P4-P5", level_readouts["P3-P4"], duration_readout)

seq.add_points("wait_P1-P2", level_waits["P0-P1"], duration_wait)
seq.add_points("wait_P3", level_waits["P2"], duration_wait)
seq.add_points("wait_P4-P5", level_waits["P3-P4"], duration_wait)
...
def perform_initialization(I, Q, P, I_st, Q_st, P_st, kind: Literal["full", "P0-P1", "P3-P4"], add_checkpoints=False, checkpoint_element=None):
...
def perform_readout(I, Q, P, I_st, Q_st, P_st, kind: Literal["full", "P0-P1", "P3-P4"], add_checkpoints=False, checkpoint_element=None):
    if add_checkpoints and checkpoint_element is not None:
        add_checkpoint_for_scope_test(checkpoint_element, all_elements=all_elements)
...
def perform_full_initialization(I, Q, P, I_st, Q_st, P_st):
    ...
    # wait_after_read_init(plungers="P0-P1")

    # 1st
    read_init3(*qua_vars1, *Nones)  # save_count = 1 -> 3
    # wait_after_read_init(plungers="P2")
    ...
    # wait_after_read_init(plungers="P3-P4")
...
def read_init12(I, Q, P, I1_st, Q1_st, P1_st, I2_st, Q2_st, P2_st, init_singlet=True):
    ...
    plungers = "P0-P1"  # "full", "P0-P1", "P3-P4"
...
def read_init45(I, Q, P, I1_st, Q1_st, P1_st, I2_st, Q2_st, P2_st, init_singlet=True):
    ...
    plungers = "P3-P4"  # "full", "P0-P1", "P3-P4"
    threshold = TANK_CIRCUIT_CONSTANTS[tank_circuit]["threshold"]
    other_elements = get_other_elements(elements_in_use=[qubit, tank_circuit] + sweep_gates, all_elements=all_elements)
