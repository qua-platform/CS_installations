...
#############################################
qubit_LO = 5.5 * u.GHz
qubit_IF = -260 * u.MHz + 21 * u.kHz
# qubit_LO = 5.2 * u.GHz
# qubit_IF = 267 * u.MHz
# qubit_LO = 5.2 * u.GHz
# qubit_IF = -265 * u.MHz

qubit_T1 = int(41.9 * u.us)
...
resonator_IF = 132 * u.MHz
# resonator_IF = -70 * u.MHz

readout_len = 4000
readout_amp = 0.1

time_of_flight = 260  # minimum 28 ns
depletion_time = 16 * u.ns
...
# IQ Plane
rotation_angle = (36.5 / 180) * np.pi
ge_threshold = -1.477e-04
