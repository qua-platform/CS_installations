...
mixer_qubit_g_q1_ef = 0.00
mixer_qubit_g_q2_ef = 0.00
mixer_qubit_phi_q1_ef = 0.0
mixer_qubit_phi_q2_ef = 0.0

mixer_qubit_g_cr_c1t2 = 0.00
mixer_qubit_g_cr_c2t1 = 0.00
mixer_qubit_phi_cr_c1t2 = 0.0
mixer_qubit_phi_cr_c2t1 = 0.0
    ...
    "mixers": {
        "mixer_q1": [
            ...
            },
            {
                "intermediate_frequency": qubit_IF_q1_ef,
                "lo_frequency": qubit_LO_q1,
                "correction": IQ_imbalance(mixer_qubit_g_q1_ef, mixer_qubit_phi_q1_ef),
            },
            {
                "intermediate_frequency": qubit_IF_cr_c1t2,
                "lo_frequency": qubit_LO_q1,
                "correction": IQ_imbalance(mixer_qubit_g_cr_c1t2, mixer_qubit_phi_cr_c1t2),
            },
        ],
        "mixer_q2": [
            {
            ...
            },
            {
                "intermediate_frequency": qubit_IF_q2_ef,
                "lo_frequency": qubit_LO_q2,
                "correction": IQ_imbalance(mixer_qubit_g_q2_ef, mixer_qubit_phi_q2_ef),
            },
            {
                "intermediate_frequency": qubit_IF_cr_c2t1,
                "lo_frequency": qubit_LO_q2,
                "correction": IQ_imbalance(mixer_qubit_g_cr_c2t1, mixer_qubit_phi_cr_c2t1),
            },
        ],
        "mixer_rr": [
            {
