...
#                  Qubits                   #
#############################################
qubit_LO_q1 = 800 * u.MHz  # Used only for mixer correction and frequency rescaling for plots or computation
# Qubits IF
...
# Relaxation time
qubit1_T1 = 10 * u.us
thermalization_time = 5 * qubit1_T1
    ...
    "controllers": {
        "con1": {
            "analog_outputs": {
                ...
                3: {"offset": 0.0},  # I qubit1 XY -> q1 I
                4: {"offset": 0.0},  # Q qubit1 XY -> q1 Q
            },
            "digital_outputs": {
                1: {},
            },
