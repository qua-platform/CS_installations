...
#                 Nanowire                  #
#############################################
nanowire_LO = 3.9 * u.GHz
nanowire_IF = 60 * u.MHz
...
config = {
    ...
    "elements": {
        ...
        "nanowire": {
            ...
            "intermediate_frequency": nanowire_IF,
            "operations": {
                "cw": "nw_const_pulse",
                "readout": "nw_readout_pulse",
            },
            "time_of_flight": time_of_flight,
            "smearing": 0,
        },
    ...
    "waveforms": {
        "nw_const_wf": {"type": "constant", "sample": nw_const_amp},
        "nw_readout_wf": {"type": "constant", "sample": nw_readout_amp},
