...
the qubit intermediate frequency in the configuration under "qubit_IF_q1".
...
Before proceeding to the next node:
    - Update the qubit frequency, labeled as "qubit_IF_q1", in the configuration.
"""
...
with program() as qubit_spec:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(df, dfs)):
            ...
            update_frequency("q1_xy", df + center)
...
if simulate:
    ...
    while results.is_processing():
        ...
        # Plot results
        plt.suptitle(f"Qubit spectroscopy - LO = {qubit_LO_q1 / u.GHz} GHz")
        plt.subplot(211)
        plt.cla()
