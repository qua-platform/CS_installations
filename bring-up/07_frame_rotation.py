...
with program() as hello_octave:
    with infinite_loop_():
        ...
        reset_if_phase("tank_circuit_dummy")
        play("readout", "tank_circuit", duration=250)
        # rotate frame by 0.5 * 2 * pi radians
        frame_rotation_2pi(0.5, "tank_circuit_dummy")
        play("readout", "tank_circuit_dummy", duration=250)
        # reset frame
        reset_frame("tank_circuit_dummy")
        # play("readout", "tank_circuit", duration=5)
        wait(50)
