...
qubit_full_scale_power_dbm_q1 = -5
qubit_full_scale_power_dbm_q2 = -5
qubit_full_scale_power_dbm_q3 = -5
qubit_full_scale_power_dbm_q4 = -5
qubit_full_scale_power_dbm_q5 = -5
qubit_full_scale_power_dbm_q6 = -5
qubit_full_scale_power_dbm_q7 = -5
# Qubits bands
...
# Qubits IF
qubit_IF_q1 = (+126 + 1.7 + 0.1)* u.MHz
qubit_IF_q2 = (-162 - 2.8 - 0.04) * u.MHz
...
# CR Drive pulse amp
cr_drive_square_amp_c1t2 = 0.8
cr_drive_square_amp_c2t1 = 0.8
cr_drive_square_amp_c2t3 = 0.8
cr_drive_square_amp_c3t2 = 0.8
cr_drive_square_amp_c3t4 = 0.8
cr_drive_square_amp_c4t3 = 0.8
cr_drive_square_amp_c4t5 = 0.8
cr_drive_square_amp_c5t4 = 0.8
cr_drive_square_amp_c5t6 = 0.8
cr_drive_square_amp_c6t5 = 0.8
cr_drive_square_amp_c6t7 = 0.8
cr_drive_square_amp_c7t6 = 0.8
...
readout_len = 800
readout_amp_q1 = 1.0 # 0.035 # our q1 as their q3
readout_amp_q2 = 1.0 # 0.035
readout_amp_q3 = 1.0
readout_amp_q4 = 1.0
...
rotation_angle_q1 = (332.1 / 180) * np.pi
rotation_angle_q2 = (70.6 / 180) * np.pi
...
ge_threshold_q1 = -3.618e-06
ge_threshold_q2 = -5.985e-06
ge_threshold_q3 = 0.0
ge_threshold_q4 = 0.0
ge_threshold_q5 = 0.0
ge_threshold_q6 = 0.0
