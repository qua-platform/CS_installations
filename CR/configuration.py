...
#############################################
# Qubits LO
qubit_LO_q1 = 4.20 * u.GHz
qubit_LO_q2 = 4.10 * u.GHz
# Qubits IF
...
# Resonators IF
resonator_IF_q1 = int(170 * u.MHz)
resonator_IF_q2 = int(50 * u.MHz)
# resontor_delay
resonator_delay = 0
    ...
    "controllers": {
        "con1": {
            "analog_outputs": {
                ...
                9: {"offset": 0.0},  # I readout line
                10: {"offset": 0.0},  # Q readout line
            },
            "digital_outputs": {
                1: {},
            },
