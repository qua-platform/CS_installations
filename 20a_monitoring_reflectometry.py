...
total_duration = 1 * 60 * 60 * u.s
# total_duration = 33360 * u.s #repaired by memory error
# total_duration = 120 * u.s
sub_duration = 60 * u.s
num_reps = total_duration // reflectometry_readout_long_length
num_outer = total_duration // sub_duration  # Number of averaging loops
num_inner = (sub_duration // reflectometry_readout_long_length)
...
# volage_p = [0.32080, 0.28900]
# for vol_p in volage_p:
