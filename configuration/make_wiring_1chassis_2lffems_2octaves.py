...
connectivity.add_qubit_drive_lines(qubits=[3], constraints=octave_spec(index=1, rf_out=4))

q2_res_ch = octave_spec(index=2, rf_out=1, rf_in=1)
connectivity.add_resonator_line(qubits=qubits_fem2, constraints=q2_res_ch)
connectivity.add_qubit_drive_lines(qubits=[4], constraints=octave_spec(index=2, rf_out=2))
connectivity.add_qubit_drive_lines(qubits=[5], constraints=octave_spec(index=2, rf_out=3))
connectivity.add_qubit_drive_lines(qubits=[6], constraints=octave_spec(index=2, rf_out=4))
