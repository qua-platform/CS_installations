...
def add_default_transmon_pair_pulses(transmon_pair):
    transmon_pair.cr_drive_control.operations["square"] = pulses.SquarePulse(amplitude=0.1, length=100)
    transmon_pair.cr_drive_target.operations["square"] = pulses.SquarePulse(amplitude=0.1, length=100)
