...
def create_quam_superconducting(
    ...
    machine.network = {
        ...
        "data_folder": r"C:\Git\QM-CS-Michal\Customers\OskarPainter\OPX1000",
    }
    ...
    RF_input_resonator.LO_frequency = RF_output_resonator.LO_frequency
    ...
    custom_port_wiring = {
        "qubits": {
            "q1": {
                ...
                "xy": (3, 3, 1, 2),  # (module, i_ch, octave, octave_ch)
